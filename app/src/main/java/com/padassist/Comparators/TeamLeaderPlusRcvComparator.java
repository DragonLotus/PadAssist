 ...
 */
public class TeamLeaderPlusRcvComparator implements Comparator<Team> {
    @Override
    public int compare(Team lhs, Team rhs) {
        if (lhs.getLead().getRcvPlus() < rhs.getLead().getRcvPlus()) {
            return 1;
        } else if (lhs.getLead().getRcvPlus() == rhs.getLead().getRcvPlus()) {
