...
//            {
//               Log.d("hello", "Added Red " + enemy.getReduction());
...
//            {
//               Log.d("hello", "Added LAKSHMI " + enemy.getReduction());
...
//            {
//               Log.d("hello", "Added TREES " + enemy.getReduction());
...
//            {
//               Log.d("hello", "Added WHITE " + enemy.getReduction());
...
//            {
//               Log.d("hello", "Added NAGGER " + enemy.getReduction());
