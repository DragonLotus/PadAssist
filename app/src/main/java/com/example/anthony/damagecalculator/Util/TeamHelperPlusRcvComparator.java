 ...
 */
public class TeamHelperPlusRcvComparator implements Comparator<Team> {
    @Override
    public int compare(Team lhs, Team rhs) {
        if (lhs.getHelper().getRcvPlus() < rhs.getHelper().getRcvPlus()) {
            return 1;
        } else if (lhs.getHelper().getRcvPlus() == rhs.getHelper().getRcvPlus()) {
