...
public abstract class Model
{
	...
	public void delete()
	{
		Cache.openDatabase().delete(mTableInfo.getTableName(), idName + "=?", new String[]
		{ getId().toString() });
	...
	public Long save()
	{
		...
		for (Field field : mTableInfo.getFields())
		{
			...
			try
			{
				...
				// TODO: Find a smarter way to
				// do this? This if block is
				// necessary because we
				// can't know the type until
				// runtime.
				if (value == null)
				{
	...
	public final void loadFromCursor(Cursor cursor)
	{
		 ...
		 * when the cursor have multiple columns with same name
		 * obtained from join tables.
		 */
	...
	public int hashCode()
	{
		...
		return hash; // To change body of generated methods,
