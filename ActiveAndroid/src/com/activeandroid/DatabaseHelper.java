...
public final class DatabaseHelper extends SQLiteOpenHelper
{
	...
	private void executePragmas(SQLiteDatabase db)
	{
		...
		// db.execSQL(".echo on;");
		// db.execSQL(".eqp on;");
		// db.execSQL(".explain ?on;");
		// db.execSQL(".stats on;");
		// db.execSQL(".timer on;");
		// db.execSQL(".timeout 300;");
		//db.execSQL("PRAGMA cache_spill=false;");
		// db.execSQL("PRAGMA SQLITE_DEBUG");
		// db.execSQL("PRAGMA journal_size_limit = ")
		// db.execSQL("PRAGMA SQLITE_MEMDEBUG");
		// db.execSQL("PRAGMA SQLITE_ENABLE_MEMORY_MANAGEMENT");
		// db.execSQL("PRAGMA SQLITE_ENABLE_EXPLAIN_COMMENTS");
		// db.execSQL("PRAGMA SQLITE_ENABLE_STAT3");
		// db.execSQL("PRAGMA .show;");
	}
	...
	private void executeCreate(SQLiteDatabase db)
	{
		...
		try
		{
			for (TableInfo tableInfo : Cache.getTableInfos())
			{
				Log.e("TABLES", "TABLE: " + tableInfo.getTableName());
